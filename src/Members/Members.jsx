                            ...
                            <div key={integrante.id}>
                                <div className="col">
                                    <div className="card h-100 shadow">
                                        ...
                                        <img src={integrante.foto} alt="" className="img-fluid" style={{ width: "620px", height: "600px" }} onMouseOver={quehagocuandosedeelevento} onMouseLeave={quehagocuandosedeelotroevento}/>
